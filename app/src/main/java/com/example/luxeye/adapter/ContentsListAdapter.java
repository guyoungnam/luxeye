...
import com.example.luxeye.BaseViewHolder;
...
public class ContentsListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ContentsListAdapter(List<YoutubeVideo> youtubeVideos) {
